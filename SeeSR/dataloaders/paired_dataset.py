...
class PairedCaptionDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.blip_model is not None:
            example["rm_input_ids"] = self.blip_model.tokenizer(tag, padding='max_length', truncation=True, max_length=35, return_tensors="pt").input_ids
            example["rm_attention_mask"] = self.blip_model.tokenizer(tag, padding='max_length', truncation=True, max_length=35, return_tensors="pt").attention_mask
